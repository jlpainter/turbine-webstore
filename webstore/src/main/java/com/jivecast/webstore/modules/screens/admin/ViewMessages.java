...
public class ViewMessages extends SecureScreen {
	...
	protected void doBuildTemplate(PipelineData pipelineData, Context context) throws Exception {
		...
		try {
			...
			int PAGE_LIMIT = 50;
			context.put("entries", CustomerContact.getAllMessages(PAGE_LIMIT, idx_id));
			context.put("current_page", idx_id);
			context.put("page_links", CustomerContact.getEventPages(PAGE_LIMIT));
